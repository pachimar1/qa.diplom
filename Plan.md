...
* Владелец: латинские буквы, без цифр и других символов.
...
3)     В поле месяц вводим значение - "10"
4)     В поле год вводим значение - "24"
...
1. **Проверяем ввод невалидных данных в поле "Номер карты". В остальные поля вводим валидные данные.**
...
2)     В поле номер карты ввести номер карты со статусом APPROVED: 4444 4444 4444 4441
3)     В поле "Месяц" вводим значение - "10"
4)     В поле "Год" вводим значение - "22"
5)     В поле "Владелец" с помощью библиотеки faker ввести русские имя и фамилию латиницей
6)     В поле cvc/cvv ввести рандомно 3 числа
7)     Нажать кнопку "Продолжить"  
...
3. **Проверяем ввод невалидного числа месяца в поле "Месяц". В остальные поля вводим валидные данные.**

1)     Нажимаем кнопку "Купить"/"Купить в кредит"
2)     В поле номер карты ввести номер карты со статусом APPROVED: 4444 4444 4444 4441
3)     В поле "Месяц" вводим значение - "14"
4)     В поле "Год" вводим значение - "24"
5)     В поле "Владелец" с помощью библиотеки faker ввести русские имя и фамилию латиницей
6)     В поле cvc/cvv ввести рандомно 3 числа
7)     Нажать кнопку "Продолжить"  
...
4. **Проверка граничащего значения в поле "Год". В остальные поля вводим валидные данные.**

1)     Нажимаем кнопку "Купить"/"Купить в кредит"
2)     В поле номер карты ввести номер карты со статусом APPROVED: 4444 4444 4444 4441
3)     В поле "Месяц" вводим значение - "10"
4)     В поле "Год" вводим значение - "99"
5)     В поле "Владелец" с помощью библиотеки faker ввести русские имя и фамилию латиницей
6)     В поле cvc/cvv ввести рандомно 3 числа
7)     Нажать кнопку "Продолжить"  
...
5. **Проверяем ввод имени владельца карты кириллицей. В остальные поля вводим валидные данные.**
...
6. **Проверяем ввод в имени владельца недопустимых символов: №;%:?. В остальные поля вводим валидные данные.** 
...
7. **Проверка ввода цифр в поле "Владелец". В остальные поля вводим валидные данные.**
...
8. **Проверка ввода нижних граничащих значений в поле "Владелец". В остальные поля вводим валидные данные.**

1)     Нажимаем кнопку "Купить"/"Купить в кредит"
2)     В поле номер карты ввести номер карты со статусом APPROVED: 4444 4444 4444 4441
3)     В поле "Месяц" вводим значение - "10"
4)     В поле "Год" вводим значение - "24"
5)     В поле "Владелец" вводим значение: А А
6)     В поле cvc/cvv ввести рандомно 3 числа
7)     Нажать кнопку "Продолжить"  
...
9. **Проверка ввода верхних граничащих значений в поле "Владелец". В остальные поля вводим валидные данные.**

1)     Нажимаем кнопку "Купить"/"Купить в кредит"
2)     В поле номер карты ввести номер карты со статусом APPROVED: 4444 4444 4444 4441
3)     В поле "Месяц" вводим значение - "10"
4)     В поле "Год" вводим значение - "24"
5)     В поле "Владелец" вводим значение: АBCD...(20 символов) АBCD...(20 символов)
6)     В поле cvc/cvv ввести рандомно 3 числа
7)     Нажать кнопку "Продолжить"  
...
10. **Проверка отправки формы заявки с пустым значением в поле "Номер карты". В остальные поля вводим валидные данные.**
...
11. **Проверка отправки формы заявки с пустым значением в поле "Месяц". В остальные поля вводим валидные данные.**
...
12. **Проверка отправки формы заявки с пустым значением в поле "Год". В остальные поля вводим валидные данные.**
...
13. **Проверка отправки формы заявки с пустым значением в поле "Владелец". В остальные поля вводим валидные данные.**
...
14. **Проверка отправки формы заявки с пустым значением в поле "CVC/CVV". В остальные поля вводим валидные данные.**
...
15. **Проверка отправки формы заявки с пустыми значениями во всех полях**
...
16. **Проверка ввода буквенных символов в поле "Номер карты". В остальные поля вводим валидные данные.**
...
17. **Проверка ввода буквенных символов в поле ввода "Месяц". В остальные поля вводим валидные данные.**
...
**Ожидаемый результат:**
При вводе буквенных символов в поле "Месяц" высвечивается ошибка: Невозможно ввести буквенные символы

18. **Проверка ввода буквенных символов в поле ввода "Год". В остальные поля вводим валидные данные.**
...
**Ожидаемый результат:**
При вводе буквенных символов в поле "Год" высвечивается ошибка: Невозможно ввести буквенные символы

19. **Проверка ввода буквенных символов в поле ввода "CVC/CVV". В остальные поля вводим валидные данные.**
...
**Ожидаемый результат:**
При вводе буквенных символов в поле "CVC/CVV" высвечивается ошибка: Невозможно ввести буквенные символы

20. **Проверка ввода несуществующего в базе номера карты. В остальные поля вводим валидные данные.**

1)     Нажимаем кнопку "Купить"
2)     В поле номер карты ввести номер карты со статусом APPROVED: 4444 4444 4444 4444
3)     В поле месяц вводим значение - "10"
4)     В поле год вводим значение - "24"
5)     В поле "Владелец" с помощью библиотеки faker ввести русские имя и фамилию латиницей
6)     В поле cvc/cvv ввести рандомно 3 числа
